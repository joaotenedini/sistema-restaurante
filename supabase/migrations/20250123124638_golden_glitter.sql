/*
  # Configuração do cash_register com políticas RLS ajustadas
  ...
  2. Segurança
    - RLS habilitado com políticas mais permissivas
...
-- Isso resolve o problema de acesso mantendo a segurança básica
CREATE POLICY "Permitir operações para usuários autenticados"
ON cash_registers
FOR ALL
TO authenticated
USING (true)
