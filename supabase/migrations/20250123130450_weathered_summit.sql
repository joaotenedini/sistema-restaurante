/*
  ...
  1. Tables
    ...
    - menu_ingredients: Link menu items to inventory items
    - inventory_alerts: System alerts for low stock and expiring items

  2. Security
    - RLS enabled on all tables
    - Read access for authenticated users
    - Write access for stock managers and admins

  3. Features
    - Automatic stock updates on transactions
    - Low stock alerts
    - Transaction history
    - Menu ingredient tracking
*/
